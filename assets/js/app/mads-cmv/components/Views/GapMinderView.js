...
import GapMinder from '../VisComponents/GapMinderVis';
...
export default class GapMinderView extends withCommandInterface(GapMinder, GapMinderForm) {
  ...
  mapData = (dataset) => {
    ...
    var currUsedField = this.props.view.settings.options.requiredFields;

    if (dataFields.length > 0 && currUsedField != undefined && !dataFields.some(e => e === currUsedField[0])) {
