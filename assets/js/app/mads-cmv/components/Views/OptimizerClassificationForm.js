...
import InputRequired from '../FormFields/InputRequired'
...
const validate = (values) => {
  ...
  if (!values.positiveLabel || values.positiveLabel=="") {
    errors.positiveLabel = 'Required';
  }

  setSubmitButtonDisable(errors.featureColumns || errors.targetColumn || errors.positiveLabel);
...
//-------------------------------------------------------------------------------------------------
const OptimizerClassificationForm = (props) => {
  // parameters and such
  const {
    handleSubmit,
    initialValues,
    ...
    <>
      <Form onSubmit={handleSubmit} ref={formElement}>
        ...
        <Form.Field>
          ...
          <Field
            name="positiveLabel"
            placeholder="Property label considered as positive, should be within Property/Target column values"
...
//=======================
const OptimizerClassificationFormWrapped = reduxForm({
  form: 'optimizer',
  validate,
})(OptimizerClassificationForm);
//=======================
...
export default OptimizerClassificationFormWrapped;
